...
(transaction_id,transaction_date,transaction_time,instore_yn,customer_id_id,product_id_id,sales_outlet_id_id,line_item_amount,line_item_id,order,promo_item_yn,quantity,staff_id,unit_price)
"""
# Execute the query
